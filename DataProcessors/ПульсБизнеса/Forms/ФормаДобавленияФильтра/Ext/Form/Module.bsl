...
Процедура ПолеПриИзмененииСервер()
	...
	Для каждого Тип Из ОписаниеТипов.Типы() Цикл
		...
		ИначеЕсли ОбщегоНазначения.ЭтоСсылка(Тип) Тогда
			...
			КоличествоЗначений = ОбщийМодульОтчеты.ОпределитьКоличествоЭлементов(Тип);
...
Процедура ОбновитьТипЗначения()
	...
	Если ЭтоСсылка И (ВидСравнения="ВИерархии" ИЛИ ВидСравнения="НеВИерархии" ИЛИ ВидСравнения="ВСпискеПоИерархии" ИЛИ ВидСравнения="НеВСпискеПоИерархии") Тогда
