...
Процедура ОбновитьКоманды(Форма, Источник) Экспорт
	...
	Для Каждого КраткиеСведенияОПодменю Из ПараметрыКлиента.ПодменюСУсловиямиВидимости Цикл
		...
		//++ Потолки
		// после обработки объекта при необходимости скрываем ее
		Если КраткиеСведенияОПодменю.Имя = "ПерваяГруппаКнопокКП" Тогда
			ИзменятьВидимость = Истина;
		КонецЕсли;
		//-- Потолки
		Для Каждого Команда Из КраткиеСведенияОПодменю.КомандыСУсловиямиВидимости Цикл
			...
			Для Каждого Объект Из ВыбранныеОбъекты Цикл
				...
				Если ТипЗнч(Команда.УсловияВидимости) = Тип("Массив")
					...
					И Не УсловияВыполняются(Команда.УсловияВидимости, Объект, Форма) Тогда
					//--
					Видимость = Ложь;
					Прервать;
				КонецЕсли;
...
Функция УсловияВыполняются(Условия
	//++ Потолки
	//, ЗначенияРеквизитов
	, ОсновныеЗначенияРеквизитов
	...
	Для Каждого Условие Из Условия Цикл
		...
		//	Продолжить;
		//КонецЕсли;
		ЗначенияРеквизитов = ОсновныеЗначенияРеквизитов;
		Если Не ЗначенияРеквизитов.Свойство(ИмяРеквизита) Тогда			
			Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДополнительныеЗначенияРеквизитов, ИмяРеквизита) Тогда 
		 		ЗначенияРеквизитов = ДополнительныеЗначенияРеквизитов;
			Иначе
				Продолжить;
			КонецЕсли;		
		КонецЕсли;		
