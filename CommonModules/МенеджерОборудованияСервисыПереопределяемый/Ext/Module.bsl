...
Процедура ЗаполнитьНастройкиУстройства(ИДУстройства, Настройки) Экспорт
	...
	//_ДемоПодключаемоеОборудованиеВызовСервера.ЗаполнитьНастройкиУстройства(ИДУстройства, Настройки);
...
Процедура ЗаполнитьПрайсЛист(ИДУстройства, СтруктураПрайсЛиста) Экспорт
	...
	//_ДемоПодключаемоеОборудованиеВызовСервера.ЗаполнитьПрайсЛист(ИДУстройства, СтруктураПрайсЛиста);
...
Процедура ЗагрузитьТовар (ИДУстройства, СтруктураТовара, Штрихкод) Экспорт
	...
	//_ДемоПодключаемоеОборудованиеВызовСервера.ЗаполнитьТовар(ИДУстройства, СтруктураТовара, Штрихкод);
...
Процедура ЗагрузитьДокумент(ИДУстройства, СтруктураОтвета, Документы) Экспорт
	...
	//_ДемоПодключаемоеОборудованиеВызовСервера.ЗагрузитьДокумент(ИДУстройства, СтруктураОтвета, Документы);
...
Процедура ЗаполнитьТипыДокументов(МассивТипов) Экспорт
	...
	//_ДемоПодключаемоеОборудованиеВызовСервера.ЗаполнитьТипыДокументов(МассивТипов);
