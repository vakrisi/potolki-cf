...
Процедура ПриСозданииНаСервере(Форма) Экспорт
	...
	Если ЕстьПравоЧтенияДанныхВерсийОбъектов() И ПолучитьФункциональнуюОпцию("ИспользоватьВерсионированиеОбъектов") Тогда
		...
		//++ Потолки (#14512 право на чтение истории предоставлять в роли, дающей право на чтение документа)
		//ПолноеИмяМетаданных = ИмяФормыМассив[0] + "." + ИмяФормыМассив[1];
		Если ПравоДоступа("Просмотр", Метаданные.Документы[ИмяФормыМассив[1]]) Тогда
			ПолноеИмяМетаданных = ИмяФормыМассив[0] + "." + ИмяФормыМассив[1];
		КонецЕсли;
		//-- Потолки 
	КонецЕсли;
