...
Функция ПараметрыФискальнойСтрокиЧека() Экспорт;
	...
	ПараметрыСтроки.Вставить("СуммаНДС"  , 0); // Число,Обязательно - Сумма НДС // №11287 было: ПараметрыСтроки.Вставить("СуммаНДС"  , Неопределено); // Число,Необязательно - Сумма НДС
