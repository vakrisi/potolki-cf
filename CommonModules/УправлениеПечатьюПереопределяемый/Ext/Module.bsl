...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	//++ Потолки: иначе не печатаются ПФ с подписями и печатями
...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.ВнутреннееПеремещениеДенежныхСредств);
	СписокОбъектов.Добавить(Документы.ВозвратМатериаловИзЭксплуатации);
	СписокОбъектов.Добавить(Документы.ВозвратПродукции);
	СписокОбъектов.Добавить(Документы.ВозвратТовараОтПокупателя);
	СписокОбъектов.Добавить(Документы.ВозвратТовараПоставщику);
	СписокОбъектов.Добавить(Документы.ВыплатаЗарплатыВНатуральнойФорме);
	СписокОбъектов.Добавить(Документы.ВыпускПродукции);
	СписокОбъектов.Добавить(Документы.Доверенность);
	СписокОбъектов.Добавить(Документы.ЗаказДоговор);
	...
	СписокОбъектов.Добавить(Документы.Замена);
	СписокОбъектов.Добавить(Документы.ЗаявкаНаДоставку);
	СписокОбъектов.Добавить(Документы.Инвентаризация);
	//СписокОбъектов.Добавить(Документы.Лид);
	СписокОбъектов.Добавить(Документы.Монтаж);
	СписокОбъектов.Добавить(Документы.ПередачаМатериаловВЭксплуатацию);
	СписокОбъектов.Добавить(Документы.ПеремещениеТоваров);
	СписокОбъектов.Добавить(Документы.ПоступлениеТоваровИУслуг);
	СписокОбъектов.Добавить(Документы.ПлатежноеПоручениеИсходящее);
	СписокОбъектов.Добавить(Документы.ПредварительныйРасчетЗаказДоговора);
	...
	СписокОбъектов.Добавить(Документы.РеализацияТоваровИУслуг);	
	СписокОбъектов.Добавить(Документы.Резервирование);	
	//СписокОбъектов.Добавить(Документы.СервисныеЗаявки);
	СписокОбъектов.Добавить(Документы.СоглашениеОРасторженииДоговора);
	...
	СписокОбъектов.Добавить(Документы.УстановкаМинимальнойСтоимостиПродукции);
	СписокОбъектов.Добавить(Документы.ЧекККМ);
	СписокОбъектов.Добавить(Документы.Штраф);
	
	СписокОбъектов.Добавить(Отчеты.ГрафикЗамеров);
