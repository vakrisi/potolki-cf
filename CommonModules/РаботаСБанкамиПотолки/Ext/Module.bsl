...
Процедура ПолучитьДанныеРБК(ПараметрыЗагрузкиКлассификатора, АдресХранилища = "") Экспорт
	...
	ТекущаяВерсияКлассификатора = Обработки.ЗагрузкаКлассификатораБанков.ДатаПоследнейЗагрузки();
...
Процедура УстановитьВерсиюКлассификатораБанков(ДатаВерсии = "")
	...
	Обработки.ЗагрузкаКлассификатораБанков.УстановитьВерсиюКлассификатора(ДатаВерсии);
...
Функция КлассификаторАктуален() Экспорт
	...
	Возврат Обработки.ЗагрузкаКлассификатораБанков.КлассификаторАктуален();
