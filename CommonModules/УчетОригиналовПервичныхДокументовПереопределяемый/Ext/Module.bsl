...
Процедура ПриОпределенииОбъектовСКомандамиУчетаОригиналов(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить("Документ.ЗаказДоговор.Форма.ФормаСписка");
    СписокОбъектов.Добавить("Документ.Монтаж.Форма.ФормаСписка");
	СписокОбъектов.Добавить("Документ.ЗаказПокупателя.Форма.ФормаСписка");
	СписокОбъектов.Добавить("Документ.РеализацияТоваровИУслуг.Форма.ФормаСписка");

	СписокОбъектов.Добавить("Обработка.РабочееМестоМенеджераРозничныхПродаж.Форма.Форма");
