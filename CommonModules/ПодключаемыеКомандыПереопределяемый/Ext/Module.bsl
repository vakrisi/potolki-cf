...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	//++ Потолки
	КомандыОбработкаОбновлений.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд);
...
Процедура ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса) Экспорт
	...
	//++ Потолки
	КомандыОбработкаОбновлений.ПриОпределенииСоставаНастроекПодключаемыхОбъектов(НастройкиПрограммногоИнтерфейса);
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	//++ Потолки
	КомандыОбработкаОбновлений.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды);
...
Процедура ПриВыводеКоманды(Команда, КомандаФормы, КнопкаФормы) Экспорт
	...
	КомандыОбработкаОбновлений.ПриВыводеКоманды(Команда, КомандаФормы, КнопкаФормы);
