...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.УправленческийБаланс);
	
	//#14300; вариант удален физически
	//ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ДетализацияВзаиморасчетовСКонтрагентом, "9194_Детальный по документам").Включен = Ложь;
	...
	//++
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ВедомостьПоДенежнымСредствам, "Основной").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ДетализацияВыпусковПродукцииПоИсполнителям, "Основной").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ДолгиПоМонтажам, "Основной").Включен = Ложь;		
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_СвободныеОстатки, "Основной").Включен = Ложь;	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_СреднийЧек, "").Включен = Ложь;
	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ИсполнениеПланаКонтактовГрафик, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ИсполнениеПланаПродажПоТочкамПродажГрафик, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ИсполнениеПланаПродажМенеджеров, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ИсполнениеПланаПродажТехнологовЗамера, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ИсполнениеПланаПродажТочекПродаж, "").Включен = Ложь;	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_КоличествоЛидовПоВидамРекламы, "").Включен = Ложь;	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ОтчетПоВходящимКонтактам, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ОтчетПоВходящимКонтактамВРазрезеВидовКонтактов, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ОтчетПоВходящимКонтактамВРазрезеМенеджеров, "").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ОтчетПоВходящимКонтактамВРазрезеРекламныхИсточников, "").Включен = Ложь;
	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_СтоимостьВыработкиПроизводства, "Основной").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ЦеныНаПленку, "Основной").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ЭффективностьРозницы, "Основной").Включен = Ложь;
	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ЭффективностьТочекПродажДиаграмма, "Основной").Включен = Ложь;
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ЭффективностьРекламныхИсточниковДиаграмма, "Основной").Включен = Ложь;
	
	ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.УДАЛИТЬ_ОтветственностьЗаБракиНаПроизводстве, "Основной").Включен = Ложь;
	
	// Отчеты больше не СКД
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьВидовКонтакта, "Основной").Включен = Ложь;	
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьРекламныхАкций, "Основной").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьРекламныхИсточников, "Основной").Включен = Ложь;	
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьТочекПродаж, "Основной").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьВидовКонтакта, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьРекламныхАкций, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьРекламныхИсточников, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьТочекПродаж, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьМенеджеров, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьМаркетинга, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	Попытка
		ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЭффективностьЗамерщиков, "").Включен = Ложь;
	Исключение		
	КонецПопытки;
	
	// "включаем" основные варианты 
	ОтчетыЭффективности.НастроитьОтчеты(Настройки);
	//--
