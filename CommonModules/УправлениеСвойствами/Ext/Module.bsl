...
Процедура ПриСозданииНаСервере(Форма, ДополнительныеПараметры = Неопределено) Экспорт
	...
	// + cmdf5
	Попытка
		ЗначениеФормыРеквизита = Форма["Свойства_НаборыДополнительныхРеквизитовОбъекта"];
	Исключение
...
Процедура СоздатьОсновныеОбъектыФормы(Форма, Контекст, СоздатьОписаниеДополнительныхРеквизитов)
	...
	Если НЕ ЕстьРеквизитФормы(Форма, "Свойства_ИспользоватьСвойства") Тогда
	...
	КонецЕсли;
	Если НЕ ЕстьРеквизитФормы(Форма, "Свойства_СкрытьУдаленные") Тогда
	...
	Если НЕ ЕстьРеквизитФормы(Форма, "ПараметрыСвойств") Тогда
	...
	Если ОпцияИспользоватьСвойства Тогда
		...
		Если СоздатьОписаниеДополнительныхРеквизитов Тогда
			...
			Если ПравоДоступа("Изменение", Метаданные.Справочники.НаборыДополнительныхРеквизитовИСведений) Тогда
				...
				Если Форма.Команды.Найти("РедактироватьСоставДополнительныхРеквизитов") = Неопределено Тогда
