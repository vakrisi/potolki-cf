...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Потолки (#9910)
	СтаршеУказанныхДней       = Параметры.СтаршеУказанныхДней;
	СтаршеУказанныхМесяцев    = Параметры.СтаршеУказанныхМесяцев;
	//-- Потолки (#9910)
	...
	//++ #16658 закомментировано - всегда расширенный режим
...
Процедура ОК(Команда)
	...
	Если ОписаниеДатыЗапрета = "" Тогда
		...
		//++ Потолки (#9910)
		ВозвращаемоеЗначение.Вставить("СтаршеУказанныхДней",      0);
		ВозвращаемоеЗначение.Вставить("СтаршеУказанныхМесяцев",   0);
		//-- Потолки (#9910)
	...
	Иначе
		...
		//++ Потолки (#9910)
		ВозвращаемоеЗначение.Вставить("СтаршеУказанныхДней",      СтаршеУказанныхДней);
		ВозвращаемоеЗначение.Вставить("СтаршеУказанныхМесяцев",   СтаршеУказанныхМесяцев);
		//-- Потолки 
