...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++15893 Запретить добавлять внешние обработки если лицензия = облако и текущий пользователь не support	 
	Если ПараметрыСеанса.ЭтоОблако И НЕ Нрег(ПользователиИнформационнойБазы.ТекущийПользователь().Имя) = "support" Тогда
		Элементы.Создать.Видимость = Ложь;
		Элементы.Создать.Доступность = Ложь;
		Элементы.ЗагрузитьИзФайла.Видимость = Ложь;
		Элементы.ЗагрузитьИзФайла.Доступность = Ложь;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.ГруппаЗагрузитьВыгрузитьМеню.ПодчиненныеЭлементы.ЗагрузитьИзФайлаМеню.Видимость = Ложь;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.ГруппаЗагрузитьВыгрузитьМеню.ПодчиненныеЭлементы.ЗагрузитьИзФайлаМеню.Доступность = Ложь;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.КнопкиДобавленияМеню.ПодчиненныеЭлементы.СоздатьМеню.Видимость = Ложь;
	Иначе
		Элементы.Создать.Видимость = Истина;
		Элементы.Создать.Доступность = Истина;
		Элементы.ЗагрузитьИзФайла.Видимость = Истина;
		Элементы.ЗагрузитьИзФайла.Доступность = Истина;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.ГруппаЗагрузитьВыгрузитьМеню.ПодчиненныеЭлементы.ЗагрузитьИзФайлаМеню.Видимость = Истина;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.ГруппаЗагрузитьВыгрузитьМеню.ПодчиненныеЭлементы.ЗагрузитьИзФайлаМеню.Доступность = Истина;
		Элементы.СписокКонтекстноеМеню.ПодчиненныеЭлементы.КнопкиДобавленияМеню.ПодчиненныеЭлементы.СоздатьМеню.Видимость = Истина;
	КонецЕсли;
	//--15893
