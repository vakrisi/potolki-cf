...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("ОткрытиеИзСписка") Тогда
		...
		Если РаботаСБанкамиПотолки.КлассификаторАктуален() Тогда
...
// Параметры:
	...
	РаботаСБанкамиПотолки.ЗагрузитьДанныеДискИТС(ПараметрыЗагрузкиФайловИТС);
...
Функция ПолучитьДанныеРБКНаСервере(ПараметрыЗагрузкиФайловРБК)
	...
	Результат = ДлительныеОперации.ВыполнитьВФоне("РаботаСБанкамиПотолки.ПолучитьДанныеРБК", ПараметрыЗагрузкиФайловРБК, ПараметрыВыполнения);
