...
Функция ПолучитьИнтернетПочтовыйПрофиль(УчетнаяЗапись) Экспорт
	...
	Профиль = Новый ИнтернетПочтовыйПрофиль;
	Если УчетнаяЗапись.ИспользоватьPOP3 Тогда
		Профиль.АдресСервераPOP3 	= УчетнаяЗапись.АдресСервераPOP3;
		...
		Профиль.Пароль 				= УчетнаяЗапись.ПарольЭлектроннойПочты;
	Иначе
		Профиль.АдресСервераIMAP 	= УчетнаяЗапись.АдресСервераPOP3;
		Профиль.ПортIMAP 			= УчетнаяЗапись.ПортPOP3;
		
		Профиль.ИспользоватьSSLIMAP = УчетнаяЗапись.ИспользоватьSSLPOP3;
		Профиль.ПользовательIMAP 	= УчетнаяЗапись.АдресЭлектроннойПочты;
		Профиль.ПарольIMAP 			= УчетнаяЗапись.ПарольЭлектроннойПочты;	
	КонецЕсли;
	...
	Профиль.ПользовательSMTP 	= УчетнаяЗапись.АдресЭлектроннойПочты;
	Профиль.АутентификацияSMTP	= СпособSMTPАутентификации.ПоУмолчанию;
	Профиль.ПарольSMTP 			= УчетнаяЗапись.ПарольЭлектроннойПочты;
