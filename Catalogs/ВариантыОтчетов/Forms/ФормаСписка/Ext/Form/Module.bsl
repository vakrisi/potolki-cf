...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Потолки #7273
	ИначеЕсли Параметры.Свойство("РежимПодбора") Тогда
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	//++ Потолки #7273
	ИначеЕсли РежимРаботыФормы = "Подбор" Тогда
		СтандартнаяОбработка = Ложь;
...
Процедура Перенести(Команда)
	...
	Для каждого ВыбранныйОтчет из ВыбранныеЗначения Цикл
		ОповеститьОВыборе(ВыбранныйОтчет);	
	КонецЦикла;
	Закрыть();
