...
Процедура УстановитьПароль(Команда)
	...
	Если СтандартныеПодсистемыКлиент.ЭтоЭлементДинамическогоСписка(ТекущиеДанные) Тогда
		...
		//++ №14991
		ДанныеПользователя = ОбщийМодульВызовСервера.ПроверитьПользователяТехподдержки(ТекущиеДанные.Наименование);
		
		Если ДанныеПользователя.ЭтоКарточкаТехподдержки И НЕ ДанныеПользователя.ТекущийСеансПоддержки Тогда
